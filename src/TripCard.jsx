                ...
                {editingActivityId === activity.id ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', width: '100%' }}>
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                      ...
                      >
                        <option value="obiectiv">Obiectiv turistic</option>
                  ...
                  <>
                    ...
                    <div className="activity-actions">
                      <button onClick={() => startEditActivity(activity)}>Editeaza</button>
                      <button onClick={() => handleDeleteActivity(activity.id)}>Sterge</button>
                    </div>
                  </>
                )}
              </li>
